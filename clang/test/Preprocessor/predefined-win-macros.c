...
// RUN:   | FileCheck -match-full-lines %s --check-prefix=CHECK-X86-BORLAND

#if defined(__BORLANDC__) && __BORLANDC__ < 0x0500
#error __BORLANDC__ must be compatible with Borland C++ 5.0 or newer
#endif

#if defined(__TURBOC__) && __TURBOC__ < 0x0500
#error __TURBOC__ must be compatible with Borland C++ 5.0 or newer
#endif

// CHECK-X86-BORLAND-NOT: #define WIN32 1
// CHECK-X86-BORLAND-NOT: #define WIN64 1
// CHECK-X86-BORLAND-NOT: #define WINNT 1
// CHECK-X86-BORLAND: #define _M_IX86 300
// CHECK-X86-BORLAND: #define _WIN32 1
// CHECK-X86-BORLAND-NOT: #define _WIN64 1
// CHECK-X86-BORLAND: #define __BIGGEST_ALIGNMENT__ 4
// CHECK-X86-BORLAND: #define __BORLANDC__ {{.*}}
// CHECK-X86-BORLAND: #define __FLAT__ 1
// CHECK-X86-BORLAND: #define __TURBOC__ {{.*}}
// CHECK-X86-BORLAND: #define __WIN32__ 1
// CHECK-X86-BORLAND: #define __int64 long long
