...
main(int argc, char **argv)
{
  ...
  dshared_ptr<ftmap_t> function_tfg_map = sym_exec_llvm::sym_exec_get_function_tfg_map(M1.get(), FunNamesVec, ctx, src_llptfg, !NoGenScev, llvmSemantics, always_use_call_context_any, ll_filename, nullptr, xml_output_format, opt_cc.value(), opt_dst_compiler.value());
