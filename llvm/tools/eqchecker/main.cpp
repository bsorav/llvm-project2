...
static cl::opt<std::string>
DynDebug(DYN_DEBUG_CMDLINE_NAME, cl::desc("<" DYN_DEBUG_CMDLINE_NAME ".  enable dynamic debugging for debug-class(es).  Expects comma-separated list of debug-classes with optional level e.g. -" DYN_DEBUG_CMDLINE_NAME "=compute_liveness,sprels,alias_analysis=2"), cl::init(""));
