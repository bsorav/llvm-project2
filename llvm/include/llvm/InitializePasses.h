...
void initializeUnseqAAWrapperPassPass(PassRegistry&);
void initializeSemanticAAWrapperPassPass(PassRegistry&);
...
void initializeRemoveAliasPredsLegacyPassPass(PassRegistry&);
