...
bool SemanticAAWrapperPass::doInitialization(Module &M)
{
  ...
  shared_ptr<SemanticAAResult::function_tfg_map_t const> function_tfg_map = make_shared<SemanticAAResult::function_tfg_map_t const>(*sym_exec_llvm::sym_exec_get_function_tfg_map(&M, set<string>()/*, false*/, g_ctx, dshared_ptr<llptfg_t const>::dshared_nullptr(), false /* gen_scev */, false /*model_llvm_semantics*/, true /* always_use_call_context_any */, "", points_to_algo_t::points_to_algo_andersen(), &value_to_name_map));
