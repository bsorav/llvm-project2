...
private:
  ...
  using code_marker_fn_t = expr_ref (context::*)(expr_ref const&, expr_id_t);
  pair<preds_t,preds_t> apply_statement_marker_function(state &state_out, preds_t const& state_assumes, code_marker_fn_t marker_fn);
