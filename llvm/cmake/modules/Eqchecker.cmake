...
set(SUPEROPT_LIBS superopt equiv fbgen eqchecker sym_exec rewrite_lib tfg graph gsupport i386 transmap exec valtag expr gas support cutils fpu parser z3 -lgmp -lgmpxx ${Boost_LIBRARIES} -ldl ${binutils_lib} -lm -lz -lmagic -lboost_filesystem -lboost_system -lssl -lcrypto)
