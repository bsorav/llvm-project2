...
set(EQ_PREBUILT_BINARY_DIR ${SUPEROPT_DIR}/../binlibs/${SUPEROPT_RELEVANT_ABUILD})
...
list(APPEND CMAKE_BUILD_RPATH ${EQ_PREBUILT_BINARY_DIR})
list(APPEND CMAKE_INSTALL_RPATH ${EQ_PREBUILT_BINARY_DIR})
...
macro(add_superopt_prebuilt_shared_lib libname)
  if (NOT TARGET ${libname})
    add_library(${libname} SHARED IMPORTED GLOBAL)
    set_target_properties(${libname} PROPERTIES IMPORTED_LOCATION ${EQ_PREBUILT_BINARY_DIR}/lib${libname}.so)
  endif()
  list(APPEND SUPEROPT_LIBS ${libname})
  #message(STATUS "SUPEROPT_LIBS=${SUPEROPT_LIBS}")
endmacro()

macro(add_superopt_prebuilt_static_lib libname)
  if (NOT TARGET ${libname})
    add_library(${libname} SHARED IMPORTED GLOBAL)
    set_target_properties(${libname} PROPERTIES IMPORTED_LOCATION ${EQ_PREBUILT_BINARY_DIR}/lib${libname}.a)
  endif()
  list(APPEND SUPEROPT_LIBS ${libname})
  #message(STATUS "SUPEROPT_LIBS=${SUPEROPT_LIBS}")
endmacro()
...
macro(add_superopt_libs ret)
  add_superopt_prebuilt_shared_lib(superopt)
  add_superopt_shared_lib(eqchecker)
  add_superopt_prebuilt_shared_lib(sym_exec)
  add_superopt_prebuilt_shared_lib(rewrite_lib)
  add_superopt_prebuilt_shared_lib(insn)
  add_superopt_shared_lib(ptfg)
  add_superopt_shared_lib(tfg)
  add_superopt_prebuilt_shared_lib(graph)
  add_superopt_shared_lib(gsupport)
  add_superopt_shared_lib(exec)
  add_superopt_shared_lib(prove)
  add_superopt_prebuilt_shared_lib(expr)
  add_superopt_prebuilt_shared_lib(valtag)
  add_superopt_prebuilt_shared_lib(support)
  add_superopt_shared_lib(cutils)
  add_superopt_shared_lib(fpu)
  add_superopt_prebuilt_static_lib(fbgen)
  add_superopt_prebuilt_static_lib(gas)
